        ...
        if ($this->form_validation->run()) {
            ...
            if ($bool_fecha_incio_curso && $bool_fecha_fin_curso) {
                $existe_curso = $this->cursos_model->valida_existe_curso(
                        $this->input->post('carrera_id_curso'), $this->input->post('curso_curso'), $this->input->post('turno_curso'), $this->session->userdata('id_profesor'), $bool_fecha_incio_curso, $bool_fecha_fin_curso, $this->input->post('hora_inicio_curso'), $this->input->post('hora_fin_curso')
                );
                if ($existe_curso ['cantidad'] > 0) {//verificamos que la clave de la materia  no exista  en la bd  para poder  ingrasar los datos de la nueva materia
                    ...
                    $this->cursos_model->insert_datos_curso(
                            $this->input->post('carrera_id_curso'), $this->input->post('curso_curso'), $this->input->post('turno_curso'), $this->session->userdata('id_profesor'), $bool_fecha_incio_curso, $bool_fecha_fin_curso, $this->input->post('hora_inicio_curso'), $this->input->post('hora_fin_curso'), $this->input->post('cupo_curso'), 1);

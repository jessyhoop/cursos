...
<div class="row mt-5">
                    ...
                    <div class="col-4 text-right">
                        <div class="form-group">
                            <input required="required" class="form-control calendario_fecha" name="fecha_inicio_curso" type="date">
                        </div>
                    </div>
                    <div class="col-4 text-right">
                        <div class="form-group">
                            <input required="required" class="form-control calendario_fecha" name="fecha_fin_curso" type="date">
                        </div>
                    </div>
                </div>
                <div class="row">
